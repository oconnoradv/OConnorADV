...
const ButtonInput = ({
  ...
  if (link) {
    return (
      </a><a href="https://www.oconnoradv.com/wp-content/plugins/wp-optimize/vendor/team-updraft/lib-onboarding-wizard/Wizard/Onboarding/src/components/Inputs/link" target='{"_blank"}' classname="{classes}">
        {children}
      </a>
    );
  }
